...
public class CanvasShapesController {
    ...
    public void initialize() {
        ...
        Stop[] stopsRadial = {new Stop(0, Color.RED), new Stop(1, Color.WHITE)};
